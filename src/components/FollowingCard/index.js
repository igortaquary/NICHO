...
const FollowingCard = ({ artistId, navigation }) => {
  ...
  const [anuncianteProfile, setAnuncianteProfile] = useState(
  ...
  return (
    <>
      {anunciante && (
        <Container
          onPress={() => {
            let auxAnunciante = { anunciante: { ...anunciante, id: artistId } };
            navigation.navigate("Página do Artista", auxAnunciante);
            // console.log(au);
          }}
        >
          <>
